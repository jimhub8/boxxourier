...
<div>
            ...
            <v-layout justify-center align-center>
                ...
                <div v-show="!loader">
                    <v-card-title>
                        ...
                        <v-tooltip right>
                            <v-btn icon slot="activator" class="mx-0" @click="getStatuses">
                    ...
                    <v-data-table :headers="headers" :loading="loading" :items="AllStatus" :search="search" counter class="elevation-1">
    ...
    <AddStatus :openAddRequest="OpenAdd" @closeRequest="close" @alertRequest="alert"></AddStatus>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            axios.patch(`/status/${this.editedItem.id}`, this.$data.editedItem)
                .then((response) => {
